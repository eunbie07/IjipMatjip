...
// 전체 방 스타일 옵션
const ROOM_STYLES = [
  { id: 'scandinavian', name: 'Scandinavian', description: '자연스럽고 따뜻한 북유럽 스타일', icon: '🏔️' },
  { id: 'modern', name: 'Modern', description: '깔끔하고 미니멀한 현대적 스타일', icon: '🏢' },
  { id: 'industrial', name: 'Industrial', description: '도시적이고 날것의 스타일', icon: '🏭' },
  { id: 'bohemian', name: 'Bohemian', description: '자유롭고 개성있는 보헤미안 스타일', icon: '🌙' },
  { id: 'vintage', name: 'Vintage', description: '클래식하고 우아한 빈티지 스타일', icon: '🏛️' }
];
